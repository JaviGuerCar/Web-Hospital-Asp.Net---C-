...
namespace HospitalFOC
{
    public partial class EliminarCita : System.Web.UI.Page
    {
        ...
        protected void btnEliminar_Cita_Click(object sender, EventArgs e)
        {
            int citas_id = Int32.Parse(txtId_cita.Text);
            lblMensaje_eliminar_cita.Text =ADOPacientes.Citas.Eliminar_Cita(citas_id);
