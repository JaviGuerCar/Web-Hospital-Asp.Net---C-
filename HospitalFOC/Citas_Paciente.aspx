<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Citas_Paciente.aspx.cs" Inherits="HospitalFOC.Citas_Paciente" %>
...
<table>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtId_cita" Text="No tiene ninguna cita solicitada" runat="server" width="300px" Enabled="False" BackColor="#CCCCCC"></asp:TextBox>
            </td>
        </tr>
        <tr>
